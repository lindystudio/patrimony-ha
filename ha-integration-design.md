...
HA OS: Add-on store → Patrimony Collection (filter/select). Also keep the custom component. Core-only: HACS/copy the custom component and use its options flow.
